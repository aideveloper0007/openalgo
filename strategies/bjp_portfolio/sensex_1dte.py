#!/usr/bin/env python
"""SENSEX 1DTE: short SENSEX OTM18 CE+PE one-day-to-expiry strangle.

Sells CE+PE at OTM18 with UnderlyingPoints leg SL 350, no leg trail,
Immediate re-entry ×5, overall SL 5000, no overall trail.
Square-off-all is true (Req 19.8).
"""
import bjp_core as core

CONFIG = core.StrategyConfig(
    strategy_name="SENSEX_1DTE",
    index=core.SENSEX,
    lots=5,
    entry_time="09:18:00",
    exit_time="15:23:00",
