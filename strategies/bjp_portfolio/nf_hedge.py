#!/usr/bin/env python
"""NF HEDGE: long NIFTY OTM20 CE+PE protective hedge.

This hedge strategy buys deep out-of-the-money NIFTY CE and PE options to provide
...
No hedge dependency — this strategy is itself the hedge. NF1 (09:25 IST) relies
on this hedge being active (entered at 09:24 IST) for tail-risk protection
(Req 17.2).
"""
import bjp_core as core

CONFIG = core.StrategyConfig(
    strategy_name="NF_HEDGE",
    index=core.NIFTY,
    lots=5,
    entry_time="09:24:00",
    exit_time="15:26:00",
