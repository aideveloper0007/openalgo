...
- [x] 14. Checkpoint - pure risk engine complete
  - Ensure all tests pass, ask the user if questions arise.
...
- [x] 19. Implement the exit manager
  ...
  - [x] 19.2 Write property test for square-off scope
  ...
  - [x] 19.3 Write property test for scheduled exit
  ...
  - [x] 19.4 Write property test for hedge no-early-exit behavior
  ...
  - [x] 19.5 Write edge-case tests for square-off failures
...
- [x] 20. Implement the logger and engine orchestration
  - [x] 20.1 Implement the IST logger
  ...
  - [x] 20.2 Implement `StrategyEngine` and `run(config)`
  ...
  - [x] 20.3 Write unit tests for startup and log content
  ...
  - [x] 20.4 Write integration test for scheduler and client init (mocked SDK)
    - Scheduler timezone is `Asia/Kolkata` (Req 6.1); client initialized with resolved api_key/host/ws_url (Req 2.6)
    - _Requirements: 2.6, 6.1_

- [x] 21. Checkpoint - engine wired end-to-end
  - Ensure all tests pass, ask the user if questions arise.

- [x] 22. Author the 10 thin per-strategy config scripts
  - [x] 22.1 Create `nf_hedge.py` and `sensex_hedge.py`
  ...
  - [x] 22.2 Create `nf1.py` and `sensex1.py`
  ...
  - [x] 22.3 Create `nf2_mean_reversion.py` and `sensex2_mean_reversion.py`
  ...
  - [x] 22.4 Create `nf3_adjustable_strangle.py` and `sensex3_adjustable_strangle.py`
  ...
  - [x] 22.5 Create `nifty_1dte.py` and `sensex_1dte.py`
...
- [x] 23. Verify deliverable structure and parameter fidelity
  - [x] 23.1 Write table-driven parameter-fidelity smoke test
  ...
  - [x] 23.2 Write structure/import smoke test
